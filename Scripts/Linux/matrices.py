...
df = pd.read_csv("/home/spqr14_/Desarrollo/Proyecto_16DeSeptiembre/Data_set/"+ archivo, sep = ',', encoding='utf8')
...
def pasar_a_csv(m, x):
    df = pd.DataFrame(m)
    df.to_csv(f"/home/spqr14_/Desarrollo/Proyecto_16DeSeptiembre/Data_set/m{x}" + archivo, index = False, sep = ',', encoding = 'utf8')
